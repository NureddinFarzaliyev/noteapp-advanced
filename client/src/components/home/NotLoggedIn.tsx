...
function NotLoggedIn() {
    return (
        <div className="bg-gray-900 md:h-dvh w-dvw p-10 md:flex justify-between">
            <div className="text-white w-[65%]">
                <h1 className="text-5xl">NoteAPP</h1>
                <p className="md:w-[50%] my-5">This is a MERN-Stack Note-taking Application which lets you create folder structure and save your notes in it. You can also customize the app with the colors you like.</p>

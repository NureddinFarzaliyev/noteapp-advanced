...
function CustomFolderSvg({width, height} : {width: number, height: number}) {

    const preferences = useContext(PreferencesContext)

    return (
    <svg width={width} height={height} viewBox="0 0 80 74" fill="none" xmlns="http://www.w3.org/2000/svg">
